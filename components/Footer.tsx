      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <h3 className="text-3xl font-display text-white mb-2">Madina Hotel</h3>
            <p className="text-gray-500">Crafting Culinary Heritage Since 1947.</p>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold text-white mb-4 tracking-wider uppercase">Explore</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold text-white mb-4 tracking-wider uppercase">Information</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-lg font-semibold text-white mb-4 tracking-wider uppercase">Contact</h4>
