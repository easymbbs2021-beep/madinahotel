...
const HomePage: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-[80vh] bg-cover bg-center" style={{ backgroundImage: "url('https://source.unsplash.com/1600x900/?luxury-indian-restaurant-dark')" }}>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-display text-gray-900 mb-6">Our Cherished History</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-10">From a small eatery to a culinary icon, our journey is as rich as our biryani. Walk through the moments that made us who we are today.</p>
          <Timeline />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-display text-gray-900 mb-16">Chef's Specials</h2>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-display text-gray-900 mb-16">Moments & Masterpieces</h2>
      ...
      <section className="bg-gray-50 py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-display text-gray-900 mb-16">What Our Guests Say</h2>
